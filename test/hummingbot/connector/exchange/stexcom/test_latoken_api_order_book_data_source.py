...
class StexcomAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = StexcomAPIOrderBookDataSource(trading_pairs=[self.trading_pair],
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.stexcom.stexcom_api_order_book_data_source"
           ".StexcomAPIOrderBookDataSource._sleep")
