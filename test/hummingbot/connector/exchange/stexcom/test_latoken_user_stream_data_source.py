...
from hummingbot.connector.exchange.stexcom import stexcom_constants as CONSTANTS  # stexcom_utils as utils
from hummingbot.connector.exchange.stexcom import stexcom_web_utils as web_utils
from hummingbot.connector.exchange.stexcom.stexcom_api_user_stream_data_source import StexcomAPIUserStreamDataSource
from hummingbot.connector.exchange.stexcom.stexcom_auth import StexcomAuth
from hummingbot.connector.time_synchronizer import TimeSynchronizer
from hummingbot.core.api_throttler.async_throttler import AsyncThrottler


class StexcomUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = StexcomAPIUserStreamDataSource(
            auth=StexcomAuth(api_key="TEST_API_KEY", secret_key="TEST_SECRET", time_provider=self.mock_time_provider),
            domain=self.domain,
    ...
    def test_get_listen_key_successful(self, mock_api):
        ...
        mock_response = {'id': 'ffffffff-ffff-ffff-ffff-ffffffffff', 'status': 'ACTIVE', 'role': 'INVESTOR',
                         'email': 'ed.rouwendaal@stexcom.com', 'phone': '', 'authorities': [],
    ...
    @patch("hummingbot.connector.exchange.stexcom.stexcom_api_user_stream_data_source.StexcomAPIUserStreamDataSource"
           "._ping_listen_key",
