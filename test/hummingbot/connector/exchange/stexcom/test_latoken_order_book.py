...
class StexcomOrderBookTests(TestCase):
    @classmethod
    ...
    def test_snapshot_message_from_exchange(self):
        ...
        snapshot_message = StexcomOrderBook.snapshot_message_from_exchange(
    ...
    def test_diff_message_from_exchange(self):
        ...
        diff_msg = StexcomOrderBook.diff_message_from_exchange(
            msg={
                "ask": [],
                "bid": [
                    {
    ...
    def test_trade_message_from_exchange(self):
        timestamp_ns = 1650122478008960306
        timestamp_s = timestamp_ns * 1e-9
        timestamp_stexcom = 1649760685161
        ...
        trade_message = StexcomOrderBook.trade_message_from_exchange(
            msg=trade_update,
            metadata={"trading_pair": self.trading_pair},
            timestamp=timestamp_ns
        )
        ...
        self.assertEqual(timestamp_stexcom * 1e-3, trade_message.trade_id)
