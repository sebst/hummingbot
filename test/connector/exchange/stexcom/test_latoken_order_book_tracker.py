...
from hummingbot.connector.exchange.stexcom.stexcom_order_book_tracker import StexcomOrderBookTracker
...
class StexcomOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[StexcomOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: StexcomOrderBookTracker = StexcomOrderBookTracker(trading_pairs=cls.trading_pairs)
