...
API_SECRET = conf.stexcom_secret_key
trading_pair = "ETH-USDT"
base_asset, quote_asset = trading_pair.split("-")
domain = "com"


class StexcomExchangeUnitTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.market: StexcomExchange = StexcomExchange(
            API_KEY,
            API_SECRET,
    ...
    def setUp(self):
        self.db_path: str = realpath(join(__file__, "../stexcom_test.sqlite"))
        try:
    ...
    def test_orders_saving_and_restoration(self):
        ...
        try:
            ...
            for event_tag in self.events:
                self.market.remove_listener(event_tag, self.market_logger)
            self.market: StexcomExchange = StexcomExchange(
                API_KEY,
                API_SECRET,
                trading_pairs=[trading_pair],
                domain=domain
