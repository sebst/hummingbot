...
from hummingbot.connector.exchange.latoken.latoken_trading_rule import (
...
class LatokenExchange(ExchangeBase):
    ...
    async def _update_order_status(self):
        ...
        tasks = [self._api_request(
            ...
            is_auth_required=True,
            return_err=False) for tracked_order in tracked_orders if tracked_order.exchange_order_id]
