...
from hummingbot.connector.exchange.stexcom.stexcom_connections_factory import StexcomConnectionsFactory
...
class StexcomWebAssistantsFactory(WebAssistantsFactory):
    def __init__(self, rest_pre_processors: Optional[List[RESTPreProcessorBase]] = None,
        ...
        self._connections_factory = StexcomConnectionsFactory()
