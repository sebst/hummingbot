...
from hummingbot.connector.exchange.stexcom import stexcom_utils as utils
from hummingbot.connector.exchange.stexcom import stexcom_web_utils as web_utils
from hummingbot.connector.exchange.stexcom.stexcom_order_book import StexcomOrderBook
...
class StexcomAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def get_last_traded_prices(cls,
        ...
        :param domain: which stexcom domain we are connecting to (the default value is 'com')
    ...
    async def get_all_mid_prices(domain=CONSTANTS.DEFAULT_DOMAIN) -> Dict[str, Decimal]:
        ...
        for record in resp_json:
            try:
                pair = await StexcomAPIOrderBookDataSource.trading_pair_associated_to_exchange_symbol(
    ...
    async def exchange_symbol_associated_to_pair(
        ...
        """
        symbol_map = await StexcomAPIOrderBookDataSource.trading_pair_symbol_map(
            domain=domain,
            api_factory=api_factory,
            throttler=throttler,
    ...
    async def get_new_order_book(self, trading_pair: str) -> OrderBook:
        ...
        snapshot_msg: OrderBookMessage = StexcomOrderBook.snapshot_message_from_exchange(
            snapshot,
            snapshot_timestamp,
    ...
    async def listen_for_trades(self, ev_loop: asyncio.AbstractEventLoop, output: asyncio.Queue):
        ...
        while True:
            try:
                ...
                trading_pair = await StexcomAPIOrderBookDataSource.trading_pair_associated_to_exchange_symbol(
                    symbol=symbol,
                    domain=self._domain,
                ...
                for trade in payload:
                    ...
                    trade_msg: OrderBookMessage = StexcomOrderBook.trade_message_from_exchange(
    ...
    async def listen_for_order_book_diffs(self, ev_loop: asyncio.AbstractEventLoop, output: asyncio.Queue):
        ...
        while True:
            try:
                ...
                order_book_message: OrderBookMessage = StexcomOrderBook.diff_message_from_exchange(
    ...
    async def _init_trading_pair_symbols(
        ...
        #     """get uuid id for stexcom ticker tag"""
